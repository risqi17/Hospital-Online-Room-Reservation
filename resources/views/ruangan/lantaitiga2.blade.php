     ...
     <div class="row">
         <div class="col-xl-12">
            ...
            @endforeach
                ...
                <div class="col-lg-2 mb-30">
                    @foreach ($kamar139 as $k139)
                        ...
                        @else
                            <div id="icu1" class="card bg-light">
                            <div class="card-header ">TERATAI</div>
                        @endif
            ...
            @foreach ($kamar141 as $k141)
                ...
                @else
                    <div id="icu1" class="card bg-light">
                    <div class="card-header ">ALAMANDA 2</div>
                @endif
