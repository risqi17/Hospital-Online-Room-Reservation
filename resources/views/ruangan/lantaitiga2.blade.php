...
@section('content')
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal231" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach ($isi231 as $i231)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/231/lantai3neo') }}"
                    ...
                    @foreach ($isi231 as $i231)
                        ...
                        @else
                            <a href="{{ url('/booking-page/231/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi231 as $i231)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/231/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal232" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi232 as $i232)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/232/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi232 as $i232)
                        ...
                        @else
                            <a href="{{ url('/booking-page/232/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi232 as $i232)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/232/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal233" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi233 as $i233)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/233/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi233 as $i233)
                        ...
                        @else
                            <a href="{{ url('/booking-page/233/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi233 as $i233)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/233/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal234" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi234 as $i234)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/234/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi234 as $i234)
                        ...
                        @else
                            <a href="{{ url('/booking-page/234/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi234 as $i234)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/234/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal235" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi235 as $i235)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/235/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi235 as $i235)
                        ...
                        @else
                            <a href="{{ url('/booking-page/235/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi235 as $i235)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/235/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal236" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi236 as $i236)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/236/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi236 as $i236)
                        ...
                        @else
                            <a href="{{ url('/booking-page/236/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi236 as $i236)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/236/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal145" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi145 as $i145)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/145/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi145 as $i145)
                        ...
                        @else
                            <a href="{{ url('/booking-page/145/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi145 as $i145)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/145/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal146" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi146 as $i146)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/146/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi146 as $i146)
                        ...
                        @else
                            <a href="{{ url('/booking-page/146/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi146 as $i146)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/146/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal237" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi237 as $i237)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/237/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi237 as $i237)
                        ...
                        @else
                            <a href="{{ url('/booking-page/237/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi237 as $i237)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/237/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal238" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi238 as $i238)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/238/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi238 as $i238)
                        ...
                        @else
                            <a href="{{ url('/booking-page/238/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi238 as $i238)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/238/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal239" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi239 as $i239)
                        @if ($i239->booked == $i239->kapasitas)
                            <form action="">
                                <input type="submit" class="btn btn-outline-primary btn-lg btn-block mb-2"
                                    value="Entry Pasien Masuk Rawat Inap" disabled>
                            </form>
                            {{-- <a href="{{ url('/booking-mrs/239/lantai3neo') }}" class="btn btn-outline-primary btn-lg btn-block" disabled>
                            Entry Pasien Masuk Rawat Inap
                        </a> --}}
                        @else
                            <a href="{{ url('/booking-mrs/239/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi239 as $i239)
                        ...
                        @else
                            <a href="{{ url('/booking-page/239/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi239 as $i239)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/239/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal242" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi242 as $i242)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/242/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi242 as $i242)
                        ...
                        @else
                            <a href="{{ url('/booking-page/242/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi242 as $i242)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/242/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal243" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi243 as $i243)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/243/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi243 as $i243)
                        ...
                        @else
                            <a href="{{ url('/booking-page/243/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi243 as $i243)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/243/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal151" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi151 as $i151)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/151/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi151 as $i151)
                        ...
                        @else
                            <a href="{{ url('/booking-page/151/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi151 as $i151)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/151/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal152" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi152 as $i152)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/152/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi152 as $i152)
                        ...
                        @else
                            <a href="{{ url('/booking-page/152/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi152 as $i152)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/152/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal153" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi153 as $i153)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/153/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi153 as $i153)
                        ...
                        @else
                            <a href="{{ url('/booking-page/153/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi153 as $i153)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/153/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal175" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi175 as $i175)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/175/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi175 as $i175)
                        ...
                        @else
                            <a href="{{ url('/booking-page/175/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi175 as $i175)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/175/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal176" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi176 as $i176)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/176/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi176 as $i176)
                        ...
                        @else
                            <a href="{{ url('/booking-page/176/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi176 as $i176)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/176/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal177" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi177 as $i177)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/177/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi177 as $i177)
                        ...
                        @else
                            <a href="{{ url('/booking-page/177/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi177 as $i177)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/177/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal240" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi240 as $i240)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/240/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi240 as $i240)
                        ...
                        @else
                            <a href="{{ url('/booking-page/240/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi240 as $i240)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/240/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal241" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi241 as $i241)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/241/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi241 as $i241)
                        ...
                        @else
                            <a href="{{ url('/booking-page/241/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi241 as $i241)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/241/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal244" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi244 as $i244)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/244/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi244 as $i244)
                        ...
                        @else
                            <a href="{{ url('/booking-page/244/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi244 as $i244)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/244/lantai3neo') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
