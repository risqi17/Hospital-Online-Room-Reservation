...
{{-- Modal Pilihan --}}
<div class="modal fade" id="ChoiceModal239" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="cModalTitle">Entry Data </h5>
            ...
            <div class="modal-body">
                @foreach ($isi239 as $i239)
                    ...
                    @else
                        <a href="{{ url('/booking-mrs/239/lantai3neo') }}" class="btn btn-outline-primary btn-lg btn-block">
                            Entry Pasien Masuk Rawat Inap
                        </a>
                    @endif
                @endforeach
                ...
                @else
                    <a href="{{ url('/booking-page/239/lantai3neo') }}" class="btn btn-outline-primary btn-lg btn-block" >
                        Entry Pasien Reservasi
                    </a>
                @endif
                @endforeach
                @foreach ($isi239 as $i239)
                    ...
                    @else
                        <a href="{{ url('/booking-keluar/239/lantai3neo') }}" class="btn btn-outline-primary btn-lg btn-block" >
                            Pasien Keluar Rawat Inap
                        </a>
                    @endif
                @endforeach
