     ...
     <div class="row">
         <div class="col-xl-12">
                        ...
                        <div class="card-body">
                            @foreach ($isi122 as $i122)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i122->booked }} dari {{ $i122->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi123 as $i123)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i123->booked }} dari {{ $i123->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi124 as $i124)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i124->booked }} dari {{ $i124->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi125 as $i125)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i125->booked }} dari {{ $i125->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi126 as $i126)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i126->booked }} dari {{ $i126->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi127 as $i127)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i127->booked }} dari {{ $i127->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi128 as $i128)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i128->booked }} dari {{ $i128->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi129 as $i129)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i129->booked }} dari {{ $i129->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi130 as $i130)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i130->booked }} dari {{ $i130->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi131 as $i131)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i131->booked }} dari {{ $i131->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi132 as $i132)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i132->booked }} dari {{ $i132->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi133 as $i133)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i133->booked }} dari {{ $i133->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi134 as $i134)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i134->booked }} dari {{ $i134->kapasitas }}</p>
                        ...
                        <div class="card-body">
                            @foreach ($isi135 as $i135)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i135->booked }} dari {{ $i135->kapasitas }}</p>
            ...
            @foreach ($kamar136 as $k136)
                ...
                @if ($k136->hasil > 0)
                    <div id="icu1" class="card bg-primary">
                    <div class="card-header text-white">SERUNI 310-136</div>
                @else
                    <div id="icu1" class="card bg-light">
                    <div class="card-header ">SERUNI 310-136</div>
                @endif
                        ...
                        <div class="card-body">
                            @foreach ($isi136 as $i136)
                                ...
                                @else
                                    ...
                                    @else
                                        <p class="card-text text-white">Terisi {{ $i136->booked }} dari {{ $i136->kapasitas }}</p>
