...
@section('content')
                    ...
                    <div class="card-body">
                        @foreach ($isi29 as $i29)
                            <h5 class="card-title text-center"><i
                                    class="material-icons">single_bed</i>{{ $i29->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal30">
                ...
                <div class="card-body">
                    @foreach ($isi30 as $i30)
                        <h5 class="card-title text-center"><i class="material-icons">single_bed</i>{{ $i30->kapasitas }}
                        </h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal31">
                ...
                <div class="card-body">
                    @foreach ($isi31 as $i31)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i31->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal32">
                ...
                <div class="card-body">
                    @foreach ($isi32 as $i32)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i32->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal33">
                ...
                <div class="card-body">
                    @foreach ($isi33 as $i33)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i33->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal179">
                ...
                <div class="card-body">
                    @foreach ($isi179 as $i179)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i179->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal35">
                ...
                <div class="card-body">
                    @foreach ($isi35 as $i35)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i35->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal36">
                ...
                <div class="card-body">
                    @foreach ($isi36 as $i36)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i36->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal37">
                ...
                <div class="card-body">
                    @foreach ($isi37 as $i37)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i37->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal38">
                ...
                <div class="card-body">
                    @foreach ($isi38 as $i38)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i38->kapasitas }}</h5>
                ...
                <a href="#" data-toggle="modal" data-target="#ChoiceModal39">
                    ...
                    <div class="card-body">
                        @foreach ($isi39 as $i39)
                            <h5 class="card-title text-center"><i
                                    class="material-icons">single_bed</i>{{ $i39->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal40">
                ...
                <div class="card-body">
                    @foreach ($isi40 as $i40)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i40->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal41">
                ...
                <div class="card-body">
                    @foreach ($isi41 as $i41)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i41->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal42">
                ...
                <div class="card-body">
                    @foreach ($isi42 as $i42)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i42->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal43">
                ...
                <div class="card-body">
                    @foreach ($isi43 as $i43)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i43->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal44">
                ...
                <div class="card-body">
                    @foreach ($isi44 as $i44)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i44->kapasitas }}</h5>
                ...
                <a href="#" data-toggle="modal" data-target="#ChoiceModal45">
                    ...
                    <div class="card-body">
                        @foreach ($isi45 as $i45)
                            <h5 class="card-title text-center"><i
                                    class="material-icons">single_bed</i>{{ $i45->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal46">
                ...
                <div class="card-body">
                    @foreach ($isi46 as $i46)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i46->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal47">
                ...
                <div class="card-body">
                    @foreach ($isi47 as $i47)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i47->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal180">
                ...
                <div class="card-body">
                    @foreach ($isi180 as $i180)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i180->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal181">
                ...
                <div class="card-body">
                    @foreach ($isi181 as $i181)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i181->kapasitas }}</h5>
                ...
                <a href="#" data-toggle="modal" data-target="#ChoiceModal182">
                    ...
                    <div class="card-body">
                        @foreach ($isi182 as $i182)
                            <h5 class="card-title text-center"><i
                                    class="material-icons">single_bed</i>{{ $i182->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal183">
                ...
                <div class="card-body">
                    @foreach ($isi183 as $i183)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i183->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal184">
                ...
                <div class="card-body">
                    @foreach ($isi184 as $i184)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i184->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal185">
                ...
                <div class="card-body">
                    @foreach ($isi185 as $i185)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i185->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal186">
                ...
                <div class="card-body">
                    @foreach ($isi186 as $i186)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i186->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal187">
                ...
                <div class="card-body">
                    @foreach ($isi187 as $i187)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i187->kapasitas }}</h5>
                ...
                <a href="#" data-toggle="modal" data-target="#ChoiceModal188">
                    ...
                    <div class="card-body">
                        @foreach ($isi188 as $i188)
                            <h5 class="card-title text-center"><i
                                    class="material-icons">single_bed</i>{{ $i188->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal189">
                ...
                <div class="card-body">
                    @foreach ($isi189 as $i189)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i189->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal190">
                ...
                <div class="card-body">
                    @foreach ($isi190 as $i190)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i190->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal191">
                ...
                <div class="card-body">
                    @foreach ($isi191 as $i191)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i191->kapasitas }}</h5>
                ...
                <a href="#" data-toggle="modal" data-target="#ChoiceModal192">
                    ...
                    <div class="card-body">
                        @foreach ($isi192 as $i192)
                            <h5 class="card-title text-center"><i
                                    class="material-icons">single_bed</i>{{ $i192->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal193">
                ...
                <div class="card-body">
                    @foreach ($isi193 as $i193)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i193->kapasitas }}</h5>
            ...
            <a href="#" data-toggle="modal" data-target="#ChoiceModal194">
                ...
                <div class="card-body">
                    @foreach ($isi194 as $i194)
                        <h5 class="card-title text-center"><i
                                class="material-icons">single_bed</i>{{ $i194->kapasitas }}</h5>
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal27" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach ($isi27 as $i27)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/27/paviliun2') }}"
                    ...
                    @foreach ($isi27 as $i27)
                        ...
                        @else
                            <a href="{{ url('/booking-page/27/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi27 as $i27)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/27/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal178" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi178 as $i178)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/178/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi178 as $i178)
                        ...
                        @else
                            <a href="{{ url('/booking-page/178/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi178 as $i178)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/178/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal28" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi28 as $i28)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/28/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi28 as $i28)
                        ...
                        @else
                            <a href="{{ url('/booking-page/28/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi28 as $i28)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/28/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal29" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi29 as $i29)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/29/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi29 as $i29)
                        ...
                        @else
                            <a href="{{ url('/booking-page/29/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi29 as $i29)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/29/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal30" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi30 as $i30)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/30/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi30 as $i30)
                        ...
                        @else
                            <a href="{{ url('/booking-page/30/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi30 as $i30)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/30/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal31" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi31 as $i31)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/31/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi31 as $i31)
                        ...
                        @else
                            <a href="{{ url('/booking-page/31/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi31 as $i31)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/31/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal32" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi32 as $i32)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/32/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi32 as $i32)
                        ...
                        @else
                            <a href="{{ url('/booking-page/32/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi32 as $i32)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/32/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal33" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi33 as $i33)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/33/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi33 as $i33)
                        ...
                        @else
                            <a href="{{ url('/booking-page/33/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi33 as $i33)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/33/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal179" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi179 as $i179)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/179/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi179 as $i179)
                        ...
                        @else
                            <a href="{{ url('/booking-page/179/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi179 as $i179)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/179/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal35" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi35 as $i35)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/35/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi35 as $i35)
                        ...
                        @else
                            <a href="{{ url('/booking-page/35/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi35 as $i35)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/35/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal36" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi36 as $i36)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/36/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi36 as $i36)
                        ...
                        @else
                            <a href="{{ url('/booking-page/36/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi36 as $i36)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/36/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal37" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi37 as $i37)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/37/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi37 as $i37)
                        ...
                        @else
                            <a href="{{ url('/booking-page/37/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi37 as $i37)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/37/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal38" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi38 as $i38)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/38/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi38 as $i38)
                        ...
                        @else
                            <a href="{{ url('/booking-page/38/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi38 as $i38)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/38/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal39" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi39 as $i39)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/39/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi39 as $i39)
                        ...
                        @else
                            <a href="{{ url('/booking-page/39/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi39 as $i39)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/39/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal40" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi40 as $i40)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/40/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi40 as $i40)
                        ...
                        @else
                            <a href="{{ url('/booking-page/40/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi40 as $i40)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/40/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal41" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi41 as $i41)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/41/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi41 as $i41)
                        ...
                        @else
                            <a href="{{ url('/booking-page/41/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi41 as $i41)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/41/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal42" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi42 as $i42)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/42/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi42 as $i42)
                        ...
                        @else
                            <a href="{{ url('/booking-page/42/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi42 as $i42)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/42/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal43" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi43 as $i43)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/43/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi43 as $i43)
                        ...
                        @else
                            <a href="{{ url('/booking-page/43/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi43 as $i43)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/43/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal44" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi44 as $i44)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/44/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi44 as $i44)
                        ...
                        @else
                            <a href="{{ url('/booking-page/44/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi44 as $i44)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/44/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal45" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi45 as $i45)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/45/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi45 as $i45)
                        ...
                        @else
                            <a href="{{ url('/booking-page/45/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi45 as $i45)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/45/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal46" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi46 as $i46)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/46/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi46 as $i46)
                        ...
                        @else
                            <a href="{{ url('/booking-page/46/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi46 as $i46)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/46/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal47" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi47 as $i47)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/47/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi47 as $i47)
                        ...
                        @else
                            <a href="{{ url('/booking-page/47/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi47 as $i47)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/47/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal180" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi180 as $i180)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/180/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi180 as $i180)
                        ...
                        @else
                            <a href="{{ url('/booking-page/180/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi180 as $i180)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/180/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal181" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi181 as $i181)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/181/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi181 as $i181)
                        ...
                        @else
                            <a href="{{ url('/booking-page/181/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi181 as $i181)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/181/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal182" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi182 as $i182)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/182/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi182 as $i182)
                        ...
                        @else
                            <a href="{{ url('/booking-page/182/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi182 as $i182)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/182/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal183" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi183 as $i183)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/183/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi183 as $i183)
                        ...
                        @else
                            <a href="{{ url('/booking-page/183/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi183 as $i183)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/183/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal184" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi184 as $i184)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/184/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi184 as $i184)
                        ...
                        @else
                            <a href="{{ url('/booking-page/184/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi184 as $i184)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/184/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal185" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi185 as $i185)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/185/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi185 as $i185)
                        ...
                        @else
                            <a href="{{ url('/booking-page/185/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi185 as $i185)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/185/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal186" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi186 as $i186)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/186/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi186 as $i186)
                        ...
                        @else
                            <a href="{{ url('/booking-page/186/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi186 as $i186)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/186/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal187" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi187 as $i187)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/187/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi187 as $i187)
                        ...
                        @else
                            <a href="{{ url('/booking-page/187/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi187 as $i187)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/187/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal188" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi188 as $i188)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/188/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi188 as $i188)
                        ...
                        @else
                            <a href="{{ url('/booking-page/188/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi188 as $i188)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/188/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal189" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi189 as $i189)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/189/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi189 as $i189)
                        ...
                        @else
                            <a href="{{ url('/booking-page/189/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi189 as $i189)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/189/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal190" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi190 as $i190)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/190/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi190 as $i190)
                        ...
                        @else
                            <a href="{{ url('/booking-page/190/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi190 as $i190)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/190/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal191" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi191 as $i191)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/191/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi191 as $i191)
                        ...
                        @else
                            <a href="{{ url('/booking-page/191/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi191 as $i191)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/191/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal192" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi192 as $i192)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/192/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi192 as $i192)
                        ...
                        @else
                            <a href="{{ url('/booking-page/192/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi192 as $i192)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/192/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal193" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi193 as $i193)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/193/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi193 as $i193)
                        ...
                        @else
                            <a href="{{ url('/booking-page/193/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi193 as $i193)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/193/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal194" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi194 as $i194)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/194/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi194 as $i194)
                        ...
                        @else
                            <a href="{{ url('/booking-page/194/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi194 as $i194)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/194/paviliun2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
