...
@section('content')
    ...
    <div class="col-lg-2 mb-30">
        @foreach ($kamar4 as $k4)
            <a href="#" data-toggle="modal" data-target="#ChoiceModal4">
                ...
                <div class="card-body">
                    @foreach ($isi4 as $i4)
                        <h5 class="card-title text-center"><i class="material-icons">single_bed</i> {{ $i4->kapasitas }}
                        </h5>
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($isi1 as $i1)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/1/icu') }}"
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($isi2 as $i2)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/2/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($isi3 as $i3)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/3/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($isi4 as $i4)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/4/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($isi5 as $i5)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/5/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($isi6 as $i6)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/6/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal217" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi217 as $i217)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/217/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi217 as $i217)
                        ...
                        @else
                            <a href="{{ url('/booking-page/217/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi217 as $i217)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/217/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal218" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi218 as $i218)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/218/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi218 as $i218)
                        ...
                        @else
                            <a href="{{ url('/booking-page/218/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi218 as $i218)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/218/icu') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
