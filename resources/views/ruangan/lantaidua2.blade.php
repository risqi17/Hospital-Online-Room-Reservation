...
@section('content')
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal110" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach ($isi110 as $i110)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/110/lantai2rba2') }}"
                    ...
                    @foreach ($isi110 as $i110)
                        ...
                        @else
                            <a href="{{ url('/booking-page/110/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi110 as $i110)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/110/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal111" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi111 as $i111)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/111/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi111 as $i111)
                        ...
                        @else
                            <a href="{{ url('/booking-page/111/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi111 as $i111)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/111/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal112" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi112 as $i112)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/112/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi112 as $i112)
                        ...
                        @else
                            <a href="{{ url('/booking-page/112/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi112 as $i112)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/112/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal113" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi113 as $i113)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/113/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi113 as $i113)
                        ...
                        @else
                            <a href="{{ url('/booking-page/113/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi113 as $i113)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/113/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal114" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi114 as $i114)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/114/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi114 as $i114)
                        ...
                        @else
                            <a href="{{ url('/booking-page/114/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi114 as $i114)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/114/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal115" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi115 as $i115)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/115/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi115 as $i115)
                        ...
                        @else
                            <a href="{{ url('/booking-page/115/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi115 as $i115)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/115/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal116" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi116 as $i116)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/116/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi116 as $i116)
                        ...
                        @else
                            <a href="{{ url('/booking-page/116/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi116 as $i116)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/116/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal117" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi117 as $i117)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/117/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi117 as $i117)
                        ...
                        @else
                            <a href="{{ url('/booking-page/117/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi117 as $i117)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/117/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal118" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi118 as $i118)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/118/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi118 as $i118)
                        ...
                        @else
                            <a href="{{ url('/booking-page/118/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi118 as $i118)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/118/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal119" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi119 as $i119)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/119/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi119 as $i119)
                        ...
                        @else
                            <a href="{{ url('/booking-page/119/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi119 as $i119)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/119/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal120" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi120 as $i120)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/120/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi120 as $i120)
                        ...
                        @else
                            <a href="{{ url('/booking-page/120/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi120 as $i120)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/120/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal121" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi121 as $i121)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/121/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi121 as $i121)
                        ...
                        @else
                            <a href="{{ url('/booking-page/121/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi121 as $i121)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/121/lantai2rba2') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
