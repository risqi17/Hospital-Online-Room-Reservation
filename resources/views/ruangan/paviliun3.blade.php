...
@section('content')
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal52" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @foreach ($isi52 as $i52)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/52/paviliun3') }}"
                    ...
                    @foreach ($isi52 as $i52)
                        ...
                        @else
                            <a href="{{ url('/booking-page/52/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi52 as $i52)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/52/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal53" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi53 as $i53)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/53/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi53 as $i53)
                        ...
                        @else
                            <a href="{{ url('/booking-page/53/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi53 as $i53)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/53/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal54" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi54 as $i54)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/54/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi54 as $i54)
                        ...
                        @else
                            <a href="{{ url('/booking-page/54/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi54 as $i54)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/54/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal55" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi55 as $i55)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/55/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi55 as $i55)
                        ...
                        @else
                            <a href="{{ url('/booking-page/55/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi55 as $i55)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/55/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal56" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi56 as $i56)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/56/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi56 as $i56)
                        ...
                        @else
                            <a href="{{ url('/booking-page/56/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi56 as $i56)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/56/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal57" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi57 as $i57)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/57/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi57 as $i57)
                        ...
                        @else
                            <a href="{{ url('/booking-page/57/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi57 as $i57)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/57/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal58" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi58 as $i58)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/58/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi58 as $i58)
                        ...
                        @else
                            <a href="{{ url('/booking-page/58/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi58 as $i58)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/58/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal59" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi59 as $i59)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/59/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi59 as $i59)
                        ...
                        @else
                            <a href="{{ url('/booking-page/59/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi59 as $i59)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/59/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal60" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi60 as $i60)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/60/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi60 as $i60)
                        ...
                        @else
                            <a href="{{ url('/booking-page/60/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi60 as $i60)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/60/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal61" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi61 as $i61)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/61/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi61 as $i61)
                        ...
                        @else
                            <a href="{{ url('/booking-page/61/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi61 as $i61)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/61/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
    ...
    {{-- Modal Pilihan --}}
    <div class="modal fade" id="ChoiceModal62" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    @foreach ($isi62 as $i62)
                        ...
                        @else
                            <a href="{{ url('/booking-mrs/62/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Masuk Rawat Inap
                            </a>
                        @endif
                    ...
                    @foreach ($isi62 as $i62)
                        ...
                        @else
                            <a href="{{ url('/booking-page/62/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Entry Pasien Reservasi
                            </a>
                        @endif
                    ...
                    @foreach ($isi62 as $i62)
                        ...
                        @else
                            <a href="{{ url('/booking-keluar/62/paviliun3') }}"
                                class="btn btn-outline-primary btn-lg btn-block">
                                Pasien Keluar Rawat Inap
                            </a>
                        @endif
